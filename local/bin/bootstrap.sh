...
{ cd /usr/local && R CMD INSTALL "BSGenome.Leishmania.panamensis.MHOMCOL81L13.v68_2024.09.tar.gz" || echo "Failed to install the BSgenome package."; }
{ cd /usr/local && R CMD INSTALL "TxDb.Leishmania.panamensis.MHOMCOL81L13.TriTrypDB.v64_2023.07.tar.gz" || echo "Failed to install the txdb package."; }
